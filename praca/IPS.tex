...
\chapter{Wykrywanie zagrożeń}
	...
	\section{SYN Flood}
		\subsection{Opis}
			...
			Czas ten często wynosi 3 sekundy. Przez ten czas, wpis jest obecny w~tablicy połączeń. Jeżeli wysłana zostanie duża ilość pakietów SYN ze zmienionymi adresami źródłowymi,
